...
const ManageBookings = () => {
  ...
  const fetchOwnerBookings = async () => {
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.message || "Failed To Fetch The Bookings Data")
      }
    } catch (error) {
  ...
  const changeBookingStatus = async (bookingId, status) => {
    try {
      ...
      if (data.success) {
        toast.success(data.message || "Booking Status Updates Successfully")
        fetchOwnerBookings();
      }
      else {
        toast.error(data.error || "Failed to Update The Booking Status")
      }
    } catch (error) {
      toast.error(error.message || "Error While Updating The Booking Status");
    }
  }
